/* ═══════════════════════════════════════════════════════
   NUESTRA HISTORIA v2.1 - PWA Edition
═══════════════════════════════════════════════════════ */
(() => {
  'use strict';
  ...
  function setupControls(){
    ...
    $('#themeBtn').addEventListener('click', () => {
      ...
      // Actualizar theme-color meta para PWA
      document.querySelector('meta[name="theme-color"]').setAttribute('content', night ? '#1a1016' : '#6b1e2b');
    });
